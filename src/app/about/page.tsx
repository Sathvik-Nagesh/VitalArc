...
export default function MethodologyPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-grid-pattern bg-[#050505]">
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="space-y-24">
          ...
          <motion.section {...fadeIn} className="relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-3xl font-black text-white">Biological Age Mapping</h2>
            </div>
            <div className="glass-card p-8 border-l-4 border-primary-500">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 text-sm">
                  <div className="p-4 glass rounded-xl border border-white/5">
                    ...
                    <p className="text-gray-500 italic">Severity is non-linear. A blood pressure of 145/90 is significantly more aging than 135/85.</p>
                  </div>
                  <div className="p-4 glass rounded-xl border border-white/5">
                    <h4 className="font-bold text-primary-400 mb-2">Heterogeneous Aging</h4>
                    <p className="text-gray-500 italic">We assess 4 organ systems independently, acknowledging that your brain might be aging slower than your heart.</p>
                  </div>
               </div>
               <p className="text-xs text-gray-500">Source markers: Albumin, Creatinine, Glucose, C-reactive protein (proxies derived from BMI/Age/Labs).</p>
            </div>
          </motion.section>
          ...
          <motion.section {...fadeIn} className="relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-3xl font-black text-white">Predictive Risk Models</h2>
            </div>
            <div className="glass-card p-8 border-l-4 border-orange-500">
               ...
               <ul className="space-y-4 mb-8">
                  <li className="flex gap-3">
                    ...
                    <span className="text-gray-400"><strong>CVD:</strong> Derived from Framingham Heart Study Pooled Cohort Equations.</span>
                  </li>
                  <li className="flex gap-3">
                    <Database className="w-5 h-5 text-orange-400 shrink-0" />
                    <span className="text-gray-400"><strong>Diabetes (T2D):</strong> Modeled after the FINDRISC (Finnish Diabetes Risk Score).</span>
                  </li>
                  <li className="flex gap-3">
                    <Brain className="w-5 h-5 text-orange-400 shrink-0" />
                    <span className="text-gray-400"><strong>Mental Health:</strong> Based on WHO-5 Wellbeing Index patterns and chronic stress correlations.</span>
                  </li>
               </ul>
          ...
          <motion.section {...fadeIn} className="relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-3xl font-black text-white">Longevity Projection</h2>
            </div>
          ...
          <motion.section {...fadeIn} className="relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-3xl font-black text-white">Privacy Architecture</h2>
            </div>
        ...
        <motion.div {...fadeIn} className="mt-32 text-center p-12 glass rounded-[3rem] border border-primary-500/20">
           ...
           <h3 className="text-4xl font-black text-white mb-4">Pure Mathematics. <br /> Total Transparency.</h3>
           <p className="text-gray-400 mb-8 max-w-lg mx-auto">Explore our source code to see exactly how your health is being scored.</p>
           <button 
